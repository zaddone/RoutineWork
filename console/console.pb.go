...
func (*LastTime) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*InstrumentSimple) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*InstrumentReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (c *greeterClient) ListInstrument(ctx context.Context, in *Request, opts ...grpc.CallOption) (Greeter_ListInstrumentClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Greeter_serviceDesc.Streams[0], c.cc, "/console.Greeter/ListInstrument", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greeterClient) StartInstrument(ctx context.Context, in *InstrumentSimple, opts ...grpc.CallOption) (*InstrumentReply, error) {
	...
	err := grpc.Invoke(ctx, "/console.Greeter/StartInstrument", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) GetLastTime(ctx context.Context, in *InstrumentSimple, opts ...grpc.CallOption) (Greeter_GetLastTimeClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Greeter_serviceDesc.Streams[1], c.cc, "/console.Greeter/GetLastTime", opts...)
	if err != nil {
		return nil, err
	}
...
func init() { proto.RegisterFile("console.proto", fileDescriptor0) }
